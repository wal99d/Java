 ...
 * @author me
 */
@WebServlet("/showApprovedDoc")
public class ShowApprovedDoc extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            byte[] file = (byte[]) session.getAttribute("approvedDoc");
            if (file == null){
                ...
                try {
                    ...
                    output.close();
                    input.close();
                    session.removeAttribute("approvedDoc");
                }
            }
    }
