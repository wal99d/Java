 ...
 * @author me
 */
@WebServlet("/ShowFinalLetterFile")
public class ShowFinalLetterFile extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            byte[] file = (byte[]) session.getAttribute("colPaper");
            if (file == null){
                ...
                try {
                    ...
                    output.close();
                    input.close();
                    session.removeAttribute("colPaper");
                }
            }
    }
