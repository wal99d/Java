 ...
 * @author me
 */
@WebServlet("/showPaidArchivedFile")
public class showPaidArchivedFile extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            byte[] file = (byte[]) session.getAttribute("paidArchivedPaper");
            if (file == null){
                ...
                try {
                    ...
                    output.close();
                    input.close();
                    session.removeAttribute("paidArchivedPaper");
                }
            }
    }
